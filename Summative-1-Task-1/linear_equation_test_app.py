...
class Test(ttk.Frame):
    def __init__(self, container, **kwargs):
        ...
        test_label = ttk.Label(self, text="Linear Equation Test", font=('Helvetica', 18, 'bold'))
        start_button = ttk.Button(self, text="Start Test", command=self.start_test)
        equation_label = ttk.Label(self, text="Equation", font=("Helvetica", 15)) # command=generate_equation
        equation_display = ttk.Label(self, textvariable=self.equation, font=("Helvetica", 15))
        user_answer_label = ttk.Label(self, text="Answer to two decimal places: ", font=("Helvetica", 15))
        user_answer_var = ttk.Entry(self, width=10, textvariable=self.answer_entry, font=("Helvetica", 15))
        self.calc_button = ttk.Button(self, text="Calculate", command=self.check_answer)
        feedback_label = ttk.Label(self, text="Solution: ", font=("Helvetica", 15))
        feedback_display =ttk.Label(self, textvariable=self.feedback_display, font=("Helvetica", 15))
        progress_label = ttk.Label(self, text="Question: ", font=("Helvetica", 15))
        progress_display = ttk.Label(self, textvariable=self.progress_display, font=("Helvetica", 15))
        score_label = ttk.Label(self, text="Score: ", font=("Helvetica", 15, 'bold'))
        score_display = ttk.Label(self, textvariable=self.score_display, font=("Helvetica", 15))
